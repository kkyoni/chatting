            ...
            <div className="navigation navbar navbar-light bg-primary">
                    ...
                    <svg height="30" width="30" viewBox="0 0 512 511">
                        <g>
                            <path
                                ...
                                data-original="#000000" className="active-path" data-old_color="#000000" fill="#3F0E40" />
                        </g>
                    </svg>
                </Link>
                <ul className="nav nav-minimal flex-row flex-grow-1 justify-content-between flex-xl-column justify-content-xl-center"
                    ...
                    <li className="nav-item">
                        <Link className={`nav-link p-0 py-xl-3 ${home === true ? 'active' : ''}`} to={"/"} title="Home">
                    ...
                    <li className="nav-item">
                        <Link className={`nav-link p-0 py-xl-3 ${profile === true ? 'active' : ''}`} to={"/Profile"} title="Profile">
                            <svg className="hw-24" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
